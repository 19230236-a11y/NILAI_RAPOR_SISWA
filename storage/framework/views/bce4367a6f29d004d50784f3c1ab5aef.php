<?php $__env->startSection('title', 'Dashboard - Staff Kurikulum'); ?>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('subjects.index')); ?>" class="btn btn-outline-warning">
                        <i class="bi bi-book me-2"></i>Kelola Mapel
                    </a>
                    <a href="<?php echo e(route('teachers.index')); ?>" class="btn btn-outline-success">
                        <i class="bi bi-person-badge me-2"></i>Kelola Guru
                    </a>
                    <a href="<?php echo e(route('programs.index')); ?>" class="btn btn-outline-primary">
                        <i class="bi bi-mortarboard me-2"></i>Kelola Jurusan
                    </a>
                    <a href="<?php echo e(route('students.index')); ?>" class="btn btn-outline-info">
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('programs.index')); ?>" class="btn btn-sm btn-outline-secondary">Lihat Jurusan</a>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="text-center p-3 border rounded">
                            <h4 class="mb-0"><?php echo e($subject->grades_count); ?></h4>
                            <small class="text-muted"><?php echo e($subject->name); ?></small>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\NILAI_RAPOR_SISWA\resources\views\dashboard\staff_kurikulum.blade.php ENDPATH**/ ?>