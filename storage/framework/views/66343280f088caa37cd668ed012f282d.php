        ...
        <nav class="sidebar-menu">
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->role === 'staff_tu'): ?>
                    ...
                    <a href="<?php echo e(route('grades.bulk-create')); ?>" class="menu-item <?php echo e(request()->routeIs('grades.bulk-create') ? 'active' : ''); ?>">
                        <i class="bi bi-stack"></i>
                        <span>Bulk Input Nilai</span>
                    </a>

                    <a href="<?php echo e(route('grades.create')); ?>" class="menu-item <?php echo e(request()->routeIs('grades.create') ? 'active' : ''); ?>">
                        <i class="bi bi-pencil-square"></i>
                        <span>Input Per Pelajaran</span>
                    </a>

                    <a href="<?php echo e(route('grades.index')); ?>" class="menu-item <?php echo e(request()->routeIs('grades.*') ? 'active' : ''); ?>">
                ...
                <?php elseif(Auth::user()->role === 'kepala_sekolah'): ?>
                    ...
                    <a href="<?php echo e(route('reports.grades')); ?>" class="menu-item <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                        <i class="bi bi-file-earmark-text"></i>
                        <span>Laporan Nilai</span>
                    </a>
                <?php endif; ?>
