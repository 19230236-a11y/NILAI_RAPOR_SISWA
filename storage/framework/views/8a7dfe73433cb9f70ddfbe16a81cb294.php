...
unset($__errorArgs, $__bag); ?>" id="nis" name="nis" value="<?php echo e(old('nis', $student->nis)); ?>" required>
                    <?php $__errorArgs = ['nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="nisn" name="nisn" value="<?php echo e(old('nisn', $student->nisn)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="birth_date" name="birth_date" value="<?php echo e(old('birth_date', $student->birth_date)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="birth_place" name="birth_place" value="<?php echo e(old('birth_place', $student->birth_place)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="address" name="address" rows="3"><?php echo e(old('address', $student->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="phone" name="phone" value="<?php echo e(old('phone', $student->phone)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="parent_name" name="parent_name" value="<?php echo e(old('parent_name', $student->parent_name)); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\NILAI_RAPOR_SISWA\resources\views\students\edit.blade.php ENDPATH**/ ?>