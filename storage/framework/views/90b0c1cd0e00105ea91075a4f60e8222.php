...
<div class="row g-4 mt-2">
    <!-- Quick Actions - Only for Admin, not for Kepala Sekolah -->
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('users.index')); ?>" class="btn btn-outline-primary">
                        <i class="bi bi-people me-2"></i>Kelola Akun Staff TU
                    </a>
                    <a href="<?php echo e(route('reports.grades')); ?>" class="btn btn-outline-info">
                        <i class="bi bi-file-earmark-text me-2"></i>Lihat Laporan Nilai
                    </a>
                </div>
            </div>
        </div>
    ...
    <?php endif; ?>
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('grades.index')); ?>" class="btn btn-sm btn-outline-secondary">Lihat Semua</a>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project TA\NILAI_RAPOR_SISWA\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>