...
<head>
    <meta charset="UTF-8">
    <title>Rapor <?php echo e($student->name); ?></title>
    <title>Arsip Rapor <?php echo e($student->name); ?></title>
        body {
        @page {
            margin: 24px 28px;
        }
                ...
                <div class="sheet">
                    ...
                    <?php $__currentLoopData = $gradesByClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classLabel => $classData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="class-block">
                            <div class="section-title"><?php echo e($classLabel); ?></div>
                            <table class="summary-grid">
                                <tr>
                                    <td><span class="label">Rata-rata</span><span class="value"><?php echo e(number_format($classData['summary']['avg'] ?? 0, 2)); ?></span></td>
                                    <td><span class="label">Tertinggi</span><span class="value"><?php echo e(number_format($classData['summary']['max'] ?? 0, 2)); ?></span></td>
                                    <td><span class="label">Terendah</span><span class="value"><?php echo e(number_format($classData['summary']['min'] ?? 0, 2)); ?></span></td>
                                    <td><span class="label">Total Nilai</span><span class="value"><?php echo e($classData['summary']['count']); ?></span></td>
                                </tr>
                            </table>
                            ...
                            <?php $__currentLoopData = $classData['periods']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period => $periodGrades): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="period-title"><?php echo e($period); ?></div>
                                <table class="detail">
                                    <thead>
                                        <tr>
                                            <th>Mapel</th>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $periodGrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo e(number_format($grade->nilai_akhir, 2)); ?></td>
...
<?php /**PATH D:\NILAI_RAPOR_SISWA\resources\views\grades\transcript-pdf.blade.php ENDPATH**/ ?>