            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h3 class="mb-0">{{ $stats['total_jurusan'] }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm bg-info bg-opacity-10 h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <a href="{{ route('students.index') }}" class="btn btn-info btn-sm mt-2">
        ...
        <div class="card border-0 shadow-sm bg-warning bg-opacity-10 h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <a href="{{ route('programs.index') }}" class="btn btn-warning btn-sm mt-2">
    ...
    <div class="col-lg-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('students.index') }}" class="btn btn-sm btn-outline-secondary">Lihat Semua</a>
            </div>
