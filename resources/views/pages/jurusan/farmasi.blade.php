    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <h2 class="section-title">Data Siswa - Farmasi</h2>
                <p class="section-lead">Kelola data absensi siswa jurusan Farmasi.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('jurusan.farmasi') }}">
