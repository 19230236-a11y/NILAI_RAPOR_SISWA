        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Teknik Kendaraan Ringan</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <h2 class="section-title">Data Siswa - Teknik Kendaraan Ringan</h2>
                <p class="section-lead">Kelola data absensi siswa jurusan Teknik Kendaraan Ringan.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('jurusan.teknik-kendaraan-ringan') }}">
