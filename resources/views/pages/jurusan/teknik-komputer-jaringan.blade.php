        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Teknik Komputer Jaringan</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <h2 class="section-title">Data Siswa - Teknik Komputer Jaringan</h2>
                <p class="section-lead">Kelola data absensi siswa jurusan Teknik Komputer Jaringan.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('jurusan.teknik-komputer-jaringan') }}">
