        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Keperawatan</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <h2 class="section-title">Data Siswa - Keperawatan</h2>
                <p class="section-lead">Kelola data absensi siswa jurusan Keperawatan.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('jurusan.keperawatan') }}">
