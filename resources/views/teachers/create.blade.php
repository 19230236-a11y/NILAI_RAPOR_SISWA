...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
    <div>
        <h2 class="mb-1">Tambah Guru</h2>
        <p class="text-secondary mb-0">Lengkapi data guru beserta mapel pengampu.</p>
    </div>
...
<form action="{{ route('teachers.store') }}" method="POST" class="card border-0 shadow-sm">
    <div class="card-body">
        @csrf
        <div class="mb-3">
            <label for="nip" class="form-label">NIP</label>
            <input id="nip" type="text" name="nip" value="{{ old('nip') }}" class="form-control @error('nip') is-invalid @enderror" required>
