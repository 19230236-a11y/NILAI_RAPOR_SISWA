            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('class_id') is-invalid @enderror" id="class_id" name="class_id" required>
                        ...
                        <option value="{{ $class->id }}" data-program-id="{{ $class->program_id }}" {{ old('class_id') == $class->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('graduation_year') is-invalid @enderror" id="graduation_year" name="graduation_year" value="{{ old('graduation_year') }}" min="{{ date('Y') }}" max="{{ date('Y') + 10 }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('parent_name') is-invalid @enderror" id="parent_name" name="parent_name" value="{{ old('parent_name') }}" maxlength="255">
                    @error('parent_name')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
